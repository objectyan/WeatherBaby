...
public class WindView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            canvas.drawText("80km/h ", fanHeight + textSize, 0, paint);
            ...
            canvas.drawText("气压 100hpa", pressureTextRight, sunArcHeight + paintTextOffset, paint);
            // draw astor info
            final float textLeft = width / 2f - sunArcRadius;// sunArcSize;
            paint.setTextAlign(Paint.Align.CENTER);
            canvas.drawText("日出 06:01", textLeft, textSize * 10.5f + paintTextOffset, paint);
            canvas.drawText("18:01 日落", width - textLeft, textSize * 10.5f + paintTextOffset, paint);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
